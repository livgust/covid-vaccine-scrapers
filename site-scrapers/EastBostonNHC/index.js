...
module.exports = async function GetAvailableAppointments(
    ...
    return site.locations.map((loc) => {
        ...
        return {
            ...
            extraData: `Open to eligible residents of the following neighborhoods: Chelsea (02150), East Boston (02128), Everett (02149), Revere (02151), South End (02118), Winthrop (02152)`,
            ...loc,
