...
async function ScrapeWebsiteData() {
    ...
    return await mychart
        ...
        .then((r) => {
            // indicate that this vaccination site has a residency restriction.
            r["restrictions"] =
                "This site is restricted to eligible people who live and work in Lynn and Nahant, (or are patients of Lynn Community Health Center).";
            console.log(r);
            return r;
        });
}
